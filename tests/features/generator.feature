Feature: Bitseed CLI integration tests
  ...
  Scenario: basic
    ...
    # deploy
    Then cmd bitseed: "deploy --fee-rate 1 --generator {{$.generator[-1][0].inscription.Id}} --tick bits --amount 210000000000 --deploy-args {"height":{"type":"range","data":{"min":1,"max":1000}}}"
